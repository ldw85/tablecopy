...
(function() {
    ...
    const translations = {
        en: {
            ...
            modal_title: 'TableCopy.pro v5.3',
    ...
    const STYLES = `
        ...
        .${CSS_PREFIX}header h3 { margin: 0; font-size: 16px; color: #333; font-weight: normal; }
        .${CSS_PREFIX}header h3 a { color: inherit; text-decoration: none; font-weight: bold; }
    ...
    function createModal(tableElement) {
        ...
        titleLink.href = 'https://tablecopy.pro';
        titleLink.target = '_blank';
        titleLink.rel = 'noopener noreferrer';
        titleLink.innerText = t('modal_title');
