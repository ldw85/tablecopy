...
(function() {
    ...
    const TOOL_REGISTRY = {
        ...
        'enable-copy': {
            ...
            color: '#2ECC71',
            description: 'Remove copy restrictions from websites',
            category: 'one-shot'
        },
        'highlight-structure': {
            ...
            color: '#E67E22',
            description: 'Visualize HTML element structure on page',
            category: 'toggle'
        },
        'image-downloader': {
            id: 'image-downloader',
            ...
            color: '#9B59B6',
            description: 'Download high-resolution images from webpages',
            category: 'modal'
        },
        'qr-code': {
            id: 'qr-code',
        ...
        'wayback': {
            ...
            color: '#A0522D',
            description: 'View current page in Internet Archive',
            category: 'one-shot'
        }
    };
    ...
    function injectUI() {
        ...
        styleSheet.id = 'webtools-modal-style';
    ...
    function cleanup() {
        ...
        const style = document.getElementById('webtools-modal-style');
